...
class SingleVideo extends Component {
    ...
    addView(){
        ...
        setTimeout(()=>{
            const api_route = 'norse-botany-324000.ue.r.appspot.com/API/AddView';
            var userId = "none"
    ...
    addLike(){
        if(this.props.user._id === undefined) {
            ...
            const api_route = 'norse-botany-324000.ue.r.appspot.com/API/AddLike';
            const postBody = {
            ...
            .then((res)=>{
                if(res !== false) {
                    ...
                    const api_route = 'norse-botany-324000.ue.r.appspot.com/API/RemoveLike';
                    const postBody = {
                        VideoId: this.state.video._id,
                        UserId: this.props.user._id
                    };
    ...
    getVideo(){
        ...
        const api_route = 'norse-botany-324000.ue.r.appspot.com/API/Video/'+ id;
        const requestMetadata = {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
    ...
    updateSecondsViewed(secondsToAdd){
        ...
        const api_route = 'norse-botany-324000.ue.r.appspot.com/API/UpdateFreeTierSeconds';
                const postBody = {
                    UserId: this.props.user._id,
